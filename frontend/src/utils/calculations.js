// Business logic for order margin calculations

export const calculateOrderMargins = (vendaValor, cacheValor) => {
...
export const formatCalculationDisplay = (calculations) => {
    return {
